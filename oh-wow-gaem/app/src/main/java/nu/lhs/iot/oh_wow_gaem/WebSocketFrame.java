...
public class WebSocketFrame {
    ...
    public static WebSocketFrame read(InputStream in) throws IOException {
        ...
        if (opCode == null) {
            throw new WebSocketException(CloseCode.ProtocolError, "Received frame with reserved/unknown opcode " + (head & 0x0F) + "build/intermediates/exploded-aar/com.android.support/appcompat-v7/22.0.0/res");
